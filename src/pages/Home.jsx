    ...
    <>
        <Container className="mb-5">
            <div className="text-center mb-4 pb-3">
                <h1>Generic Title</h1>
                <p className="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni pariatur minima, corrupti voluptate natus hic sunt atque rerum repellat id quos suscipit accusamus ab dolore adipisci earum blanditiis neque consectetur cum! Praesentium neque corrupti atque incidunt, animi saepe alias dolorem.</p>
            </div>

            <Container className="mt-4">
              <Row className="mb-5 pb-2">
                <Col className="d-flex justify-content-center">
                  <ImgOverlay radius="200" width="500px" height="300px" src={blog}/>
                </Col>
                <Col>
